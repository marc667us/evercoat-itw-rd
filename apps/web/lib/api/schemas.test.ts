...
import { formulaSchema } from "./formulations";
...
describe("projectSchema", () => {
  ...
  it("accepts a row with target_release_date absent entirely", () => {
    // The API model declares it `object | None = None`, so it may be
    // MISSING rather than null. Rejecting that would refuse valid rows.
